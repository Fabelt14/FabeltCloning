...
import os,sys,time,datetime,random,hashlib,re,threading,json,urllib,cookielib,requests,mechanize from multiprocessing.pool import ThreadPool
...
\033[1;96m|-------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-----|
\033[1;96m|                Anonymous                  |
\033[1;96m|This Tool is Only for All FB Acounts       |
\033[1;96m|------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+------|
\033[1;91m [⚡\033[1;97mAuthor Name: Asekun Fatai           ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mYutube Chnl: Fabelt the Hackerdaddy ⚡\033[1;91m]
\033[1;91m [⚡       \033[1;97mFrom: Nigeria               ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mFabelt\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
\033[1;92mNote2: This Tool is only for Nigeria
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mfabelt\033[1;95m-_-_-_-_-_-_-_-_-»
 """
CorrectUsername = "fabelt"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Asekun_Fatai
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Asekun_Fatai
	print logo
	...
	print "\033[1;97m[3]\x1b[1;92mSubscribe Fabelt the Hacker Daddy Youtube Channel " 
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mfabelt\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
